  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      >
        {/* Header */}
        <DialogHeader
          className="relative text-white py-4 px-6 rounded-t-2xl flex items-center justify-center shadow-md"
          style={{
            backgroundColor: "#AFC2D5", // <-- exact color from provided image
          }}
        >
          <div className="flex items-center justify-between w-full max-w-sm">
            {/* Bulkwala Logo (largest) */}
            <img
        ...
        <div className="p-6 sm:p-8 bg-white max-h-[70vh] overflow-y-auto scrollbar-thin scrollbar-thumb-[#AFC2D5]/40 scrollbar-track-transparent hover:scrollbar-thumb-[#AFC2D5]/60">
          <div className="text-center text-gray-700 space-y-1.5 mb-4">
            <p className="text-[17px] sm:text-[18px] font-semibold">
              Join the{" "}
              <span className="font-bold text-[#AFC2D5]">Bulkwala</span> family
              & start saving today!
            </p>
          ...
          {/* Offer Highlight */}
          <div className="bg-[#F3F6FA] border border-[#D7E2ED] text-[#476A8B] font-semibold rounded-full px-6 py-2 text-center mb-6 text-sm sm:text-[15px] shadow-sm">
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
              ...
              <Button
                type="submit"
                className="w-full bg-[#AFC2D5] hover:bg-[#96B4CE] text-white font-semibold rounded-lg py-2.5 mt-2 shadow-md transition-all"
